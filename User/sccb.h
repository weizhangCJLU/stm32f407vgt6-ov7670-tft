...
#define _sccb_H
  ...
  #include "stm32f4xx.h"
  #define OV7670_RGB_REG_NUM  168
  #define OV7670_YUV_REG_NUM  178

  #define  SCCB_SDA_PIN   GPIO_Pin_13//PC13
  #define  SCCB_SCL_PIN   GPIO_Pin_3//PB3
  ...
  #define Sensor_VSYNC_PIN    GPIO_Pin_7//PB7:VSYNC
  ...
  #define GPIO_PORT_SOURCE_VSYNC_CMOS        GPIO_PortSourceGPIOC//配置GPIO外部中断使用GPIO_PortSourceGPIOC和GPIO_PinSource3
  #define GPIO_PIN_SOURCE_VSYNC_CMOS         GPIO_PinSource3//PC3

/////////////////////////////////////////PA8:AF0:MCO1 PC9:AF0:MCO2
...
void OV7670_Window_Set(u16 sx,u16 sy,u16 width,u16 height);//设置窗口
